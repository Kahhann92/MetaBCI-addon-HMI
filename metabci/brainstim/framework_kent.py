    ...
    def update_startup(self):
        ...
        if "expguide_textstim" not in stims:
            stims["expguide_textstim"] = visual.TextStim(
                win,
                text="Take a few long breath and close your eyes a little while.\nTake your time to have some rest.\n"
                "You can press space or enter to continue.",
                units="height",
                pos=[0, 0.15],
                height=0.04,
                color="#ffffff",
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                keys = event.getKeys(keyList=["q", "up", "down", "return","space"])
