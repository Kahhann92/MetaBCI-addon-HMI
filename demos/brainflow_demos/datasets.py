...
filepath_mi = "data\\mi"
filepath_ssvep = "data\\ssvep"                                                  # 数据的相对路径
MetaBCIData_URL = {
...
class MetaBCIData(BaseDataset):
    _EVENTS = {
        ...
        'ssvep': {
            ...
            '11': (11,'k'), '12': (12,'l'), '13': (13,'m'), '14': (14,'n'), '15': (15,'o'),
            '16': (16,'p'), '17': (17,'q'), '18': (18,'r'), '19': (19,'s'), '20': (20,'t'),
        }
    }
    ...
    def data_path(self, 
        ...
        for sub in self.subjects:
            dests.append(['{:s}\\sub{:d}\\{:d}.cnt'.format(base_url, sub, run) for run in runs])
        return dests
